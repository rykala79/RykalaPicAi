...
const CreatePost = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        <h1 className="font-extrabold text-[#18277ee5] text-[32px]">Create</h1>
        <p className="mt-2 text-[#2e308fef] text-[16px] max-w [500px]">
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="mt-5 flex gap-5">
          <button
            ...
            className="text-white bg-blue-500 font-medium rounded-md 
        ...
        <div className="mt-10">
          <p className="mt-2 text-[#2f2681a2] text-[14px]">
